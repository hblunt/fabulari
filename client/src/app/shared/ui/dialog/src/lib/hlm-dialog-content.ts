...
export class HlmDialogContent {
  ...
  constructor() {
    classes(() => [
      'bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 ring-foreground/10 relative mx-auto grid w-[36rem] max-w-[calc(100vw-2rem)] gap-6 rounded-xl p-6 text-sm ring-1 outline-none duration-100',
